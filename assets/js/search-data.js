...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/sushantCV/sushantCV.pdf";
          },
        },{id: "nav-research",
          title: "Research",
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%75%73%68%61%6E%74.%73%69%6E%67%68@%6F%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/sushantsinghss", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/sushantsinghss", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0000-7232-7983", "_blank");
        },
      },{
        id: 'social-arxiv_id',
        title: 'Arxiv_id',
